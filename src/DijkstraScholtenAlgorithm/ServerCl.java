...
public class ServerCl extends Thread {
...
//    public ServerCl(int myId, int myPortNo, Clock clock, Relations relations, ReadFromFile lists) {
//        this.myNodeId = myId;
...
//    }
    ...
    ServerCl(int myNodeId, int myPortNo, Clock clock, Relations relations, ReadFromFile lists) {
